-- =====================================================
-- Bell notifications: add billing lifecycle events
-- =====================================================
...
comment on function public.get_bell_notifications is
  'Return personal, challenge, care, invite, and billing bell notifications for the current user from notification_queue.';
