-- =====================================================
-- Bell notifications: add invite_joined kind
-- =====================================================
...
comment on function public.get_bell_notifications is
  'Return personal, pattern trigger, challenge, care outcome, and invite-joined bell notifications for the current user from notification_queue.';
